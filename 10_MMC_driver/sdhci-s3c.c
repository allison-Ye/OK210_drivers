...
#include "sdhci.h"
#define S3C_SDHCI_NORINTSTS			(0x30)//zdgadd
#define S3C_SDHCI_ERRINTSTS			(0x32)//zdgadd
#define S3C_SDHCI_CONTROL4			(0x8C)//zdgadd
#define SDHCI_S3C_CONTROL4_BUSY			(1)//zdgadd
